...
def main():
    ...
    subset_import(subset_path="/media/user/2nd_disk/sen_processed_dir/subset",
                  filelist_path="/home/user/Desktop/GRASS Jena Workshop/sentinel-filelist.txt", overwrite_bool=True)
    create_stc(overwrite_bool=True, filelist_path="/home/user/Desktop/GRASS Jena Workshop/sentinel-filelist.txt")
