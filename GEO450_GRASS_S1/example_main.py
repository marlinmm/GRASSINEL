...
def main():
    ...
    subset_import(subset_path=Paths.subset_path, overwrite_bool=True, output="raster", polarization_type="VH")
    create_stc(overwrite_bool=True, output="stc", polarization_type="VH")
