...
def main():
    ...
    # sen_download_extended(start_time="2020-05-01", end_time="2020-06-05", sort_by="ingestiondate",
    #                       relative_orbit_number=168)

    # ########## SENTINEL PREPROCESSING FUNCTION(S) #############
    # !!!!! terrain_flat_bool needs to be set to False, or VV_data don't contain any information !!!!! #
    # pyroSAR_processing(down_path=Paths.sen_down_path, processed_path=Paths.sen_processed_path, target_resolution=50,
    #                    target_CRS=32632, terrain_flat_bool=False, remove_therm_noise_bool=True)
